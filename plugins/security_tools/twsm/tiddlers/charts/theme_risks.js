...
tags: 
title: $:/plugins/security_tools/twsm/charts/theme_risks
type: application/javascript
module-type: echarts-component
echarts-refresh-trigger: [twsm_class[theme]twsm_security_score[]twsm_json_field:risk_count[]]
\*/
...
exports.onUpdate = function (echart) {
  ...
  $tw.utils.each(
    $tw.wiki.filterTiddlers(
      "[twsm_class[theme]sort[]twsm_security_score[]twsm_json_field:risk_count[]]"
    ),
    function (riskCount) {
      maxRiskCount = Math.max(maxRiskCount, riskCount);
      riskCounts.push(riskCount);
    }
  );
